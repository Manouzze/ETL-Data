...
for day in range(1, 2):
    ...
    products_data.extend([
        (plat1, 'vegetarien', plat1_quantity, 'plats', plat1_glucides, plat1_sodium, 1),
        (dessert1, 'vegetarien', dessert1_quantity, 'desserts', dessert1_glucides, dessert1_sodium, 1),
        (plat2, 'vegetarien', plat2_quantity, 'plats', plat2_glucides, plat2_sodium, 1),
        (dessert2, 'vegetarien', dessert2_quantity, 'desserts', dessert2_glucides, dessert2_sodium, 1),
    ])
